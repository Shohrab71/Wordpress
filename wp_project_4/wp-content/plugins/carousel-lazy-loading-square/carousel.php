...
function np_register_scripts() {
    if (!is_admin()) {
        ...
        wp_register_script('np_script', plugins_url('square1.min.js', __FILE__));
        wp_register_script('np_script1', plugins_url('square1.js', __FILE__));
...
function np_register_styles() {
    // register
    wp_register_style('np_styles_theme', plugins_url('square1.css', __FILE__));
    wp_register_style('np_styles_theme1', plugins_url('square1.min.css', __FILE__));
 
    // enqueue
    wp_enqueue_style('np_styles_theme');
    wp_enqueue_style('np_styles_theme1');
}
