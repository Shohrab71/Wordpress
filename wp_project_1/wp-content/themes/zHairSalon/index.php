	...
	<div class="wrap-container">
		...
		<section class="content-box boxstyle-1 box-1">
			<div class="zerogrid">
				<div class="row wrap-box"><!--Start Box-->
					<div class="col-1-2">
						<div class="wrap-col">
							<h1>Welcome To<br><span><?php bloginfo('name')?></span></h1>
							<p class="lead">Pellentesque habitant orbi tristique senectus et netus et malesuada fames ac turpis egestas.</p>
					...
					<div class="row">
						<div class="col-1-4">
							<div class="portfolio-box zoom-effect">
								<img src="<?php echo get_template_directory_uri();?>/images/3333.jpg" class="img-responsive" alt="">
									...
									<div class="portfolio-box-caption-content">
										...
										<div class="project-social">
											<ul class="list-inline">
												...
												<li><a href="<?php echo get_template_directory_uri();?>/images/3333.jpg" data-lightbox="example-set" data-title="Click the right half of the image to move forward."><i class="fa fa-search"></i></a></li>
											</ul>
										</div>
									</div>
								</div>
						...
						<div class="col-1-4">
							<div class="portfolio-box zoom-effect">
								<img src="<?php echo get_template_directory_uri();?>/images/2222.jpg" class="img-responsive" alt="">
								<div class="portfolio-box-caption">
									<div class="portfolio-box-caption-content">
										<div class="project-name">
											Project Name
										...
										<div class="project-social">
											<ul class="list-inline">
												<li><a href="single.html"><i class="fa fa-link"></i></a></li>
												<li><a href="<?php echo get_template_directory_uri();?>/images/2222.jpg" data-lightbox="example-set" data-title="Click the right half of the image to move forward."><i class="fa fa-search"></i></a></li>
											</ul>
										</div>
									</div>
								</div>
								...
								<div class="portfolio-box-caption">
									<div class="portfolio-box-caption-content">
										...
										<div class="project-social">
											<ul class="list-inline">
												<li><a href="single.html"><i class="fa fa-link"></i></a></li>
												<li><a href="<?php echo get_template_directory_uri();?>/images/1.jpg" data-lightbox="example-set" data-title="Click the right half of the image to move forward."><i class="fa fa-search"></i></a></li>
											</ul>
										</div>
									</div>
								</div>
						...
						<div class="col-1-4">
							<div class="portfolio-box zoom-effect">
								<img src="<?php echo get_template_directory_uri();?>/images/4.jpg" class="img-responsive" alt="">
								<div class="portfolio-box-caption">
									<div class="portfolio-box-caption-content">
										<div class="project-name">
											Project Name
										...
										<div class="project-social">
											<ul class="list-inline">
												<li><a href="single.html"><i class="fa fa-link"></i></a></li>
												<li><a href="<?php echo get_template_directory_uri();?>/images/4.jpg" data-lightbox="example-set" data-title="Click the right half of the image to move forward."><i class="fa fa-search"></i></a></li>
											</ul>
										</div>
									</div>
								</div>
		...
		<section class="content-box boxstyle-3 box-3 ">
			<div class="portfolio-box">	
				<img src="<?php echo get_template_directory_uri();?>/images/rings.jpg"alt="">
				<div class="portfolio-box-caption">
					<div class="portfolio-box-caption-content">
						<div class="project-category">
							New Collection
				...
				<div class="row wrap-box"><!--Start Box-->
					...
					<div class="row"><!--Testimonials Box-->
						<div id="owl-testimonials" class="owl-carousel t-center">
							...
							<div class="item testimonials-item">
								<img src="<?php echo get_template_directory_uri();?>/images/partner1.png" />
								<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley.</p>
								<h5>Catherine Grace - America</h5>
							</div>
							<div class="item testimonials-item">
